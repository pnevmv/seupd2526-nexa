#!/usr/bin/env python3
"""Apply BM25+BGE-M3 score fusion at alpha=0.70 for all three dev sets (top-1000).

Reads wider-*-dev-lexical.txt run files + precomputed doc embeddings, encodes
queries with BGE-M3, fuses, and writes TREC output.

Usage:
    python3 generate_dev_fusion_runs.py [--alpha 0.70] [--top-k 1000] [--batch-size 32]
"""
...
LANG_CONFIGS = {
    "en": {
        ...
        "out_file":   REPO_ROOT / "runs/hybrid-en-dev-bge-fusion-1000.txt",
        "run_tag":    "hybrid-en-dev-bge-fusion-1000",
    },
    "fr": {
        ...
        "out_file":   REPO_ROOT / "runs/hybrid-fr-dev-bge-fusion-1000.txt",
        "run_tag":    "hybrid-fr-dev-bge-fusion-1000",
    },
    "de": {
        ...
        "out_file":   REPO_ROOT / "runs/hybrid-de-dev-bge-fusion-1000.txt",
        "run_tag":    "hybrid-de-dev-bge-fusion-1000",
    },
}
