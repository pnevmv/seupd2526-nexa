...
/**
 * Lucene analyzer for German text.
 * <p>
 * The analyzer is configured through {@code config_de.yml} and supports
...
public class GermanAnalyzer extends Analyzer {
    ...
    /**
     * Supported stemming / lemmatization strategies for German.
     */
     ...
     */
    public GermanAnalyzer(final TokenizerType tokenizerType,
                          final int minLength,
                          final int maxLength,
    ...
    /**
     * Creates a German analyzer using the YAML configuration.
     */
    ...
    private static TokenStream applyStemFilter(final TokenStream filter, final StemFilterType stemFilterType) {
        return switch (stemFilterType) {
            case GERMANMINIMAL -> new GermanMinimalStemFilter(filter);
            case GERMANLIGHT -> new GermanLightStemFilter(filter);
            case GERMAN -> new GermanStemFilter(filter);
