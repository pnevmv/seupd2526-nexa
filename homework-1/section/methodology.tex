...
\begin{itemize}
    ...
    \item \textbf{ShingleFilter:} Generates words with n-grams to capture local contextual information.
...
These subqueries are combined using a Boolean query with \texttt{ON} clauses, allowing documents to be retrieved if they match either field. This formulation increases recall while maintaining flexibility in matching.
