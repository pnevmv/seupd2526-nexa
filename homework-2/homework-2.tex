...
%%
%% The "title" command
\title{SEUPD@CLEF: Team NEXA on Hybrid Source Retrieval for Cross-Lingual Scientific Web Claims}
\title[mode=sub]{Notebook for the CheckThat! Lab at CLEF 2026}
...
\begin{keywords}
  ...
  Multilingual Retrieval \sep
  Hybrid Retrieval \sep
  Dense Retrieval \sep
  BM25 \sep
  BGE-M3 \sep
  Score Fusion \sep
  Cross-Encoder Re-ranking \sep
